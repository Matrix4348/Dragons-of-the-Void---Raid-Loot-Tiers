...
* On Google Chrome, Microsoft Edge and probably other Chrome-derivated browsers, [Tampermonkey needs you to either enable developer mode or allow the extension to run user scripts](https://www.tampermonkey.net/faq.php#Q209). Other user script managers may need similar actions.
...
Please, report any bug or missing data here on Greasyfork (if you have an account) or on GitHub (if you have an account...).
