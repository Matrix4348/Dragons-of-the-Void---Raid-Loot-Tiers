...
var options_div, main_div, in_raid_div;
var button_pressed=false, in_raid_button_pressed=false;
var difficulties_to_display_default={"Easy":1,"Hard":1,"Legendary":1};
var automatically_show_in_raid_div_default=1;
var current_tab_default="All raids";
var difficulties_to_display, automatically_show_in_raid_div, current_tab;
...
function initialize_saved_variables(){ // Note: Just in case, global variables and stored variables will be used in parallel.
    ...
    difficulties_to_display.Legendary=GM_getValue("Easy_stored",difficulties_to_display_default.Legendary);
...
function press_in_raid_button(){
    if(in_raid_button_pressed==true){ in_raid_div.style.display="none"; in_raid_button_pressed=false; }
    else{ in_raid_div.style.display=""; in_raid_button_pressed=true; }
}
