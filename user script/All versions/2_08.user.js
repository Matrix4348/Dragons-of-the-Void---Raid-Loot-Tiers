    ...
    constructor(a,b,c,dmg,d,e,f,g,h,i,j,k,l,m,n,o) {
        ...
        for(let v1 of [0,1,2]){
            for(let v2=0;v2<this[["Easy","Hard","Legendary"][v1]+" tiers"].length;v2++){
                ...
                if(typeof(i)=="undefined"){ n[v1][v2]="maybe"; } else if(this.has_hidden_loot){ if(typeof(n[v1][v2])=="undefined"){ n[v1][v2]="?"; } } else{ if(typeof(n[v1][v2])=="undefined"){ n[v1][v2]=0; } }
                if(typeof(j)=="undefined"){ o[v1][v2]="maybe"; } else if(this.has_summoner_loot){ if(typeof(o[v1][v2])=="undefined"){ o[v1][v2]="?"; } } else{ if(typeof(o[v1][v2])=="undefined"){ o[v1][v2]=0; } }
            }
        }
...
var raid_list={
    ...
    "Basiliscus":new raid("Medium","Guild raid","EHL",["Poison",24,70,260],["320,000","960,000","2,880,000"],["12,000","40,000","75,000","120,000","180,000","320,000","425,000","530,000","640,000"],["???","960,000","???"],["???","2,880,000","???"],"",true,false,[[1,1,2,2,2,3,3,3,4],[],[]],[[0,1,1,2,2,2,3,3,3],[],[]],[[0,0,0,0,1,1,1,2,2],[],[]],[[],[],[]],[[],[],[]]),
    "Basiliscus (temporary beta world raid)":new raid("World","World raid","image",["Poison",12],[],[],[],["https://cdn.discordapp.com/attachments/739356891762655372/1051162576899280916/Basiliscus.png"],"https://cdn.discordapp.com/attachments/739356891762655372/1051162576899280916/Basiliscus.png"),
    ...
    "Fungal Fiend":new raid("Small","Guild raid","EHL",["Nature",6,30,140],["20,000","60,000","180,000"],["500","1,000","5,000","10,000","20,000","25,000","30,000","40,000","50,000"],["2,000","5,000","10,000","20,000","30,000","60,000","75,000","90,000","120,000","150,000"],["???","180,000","???"],"",false,false,[[1,2,3,3,3,3,4,4,4],[1,2,2,2,3,3,4,4,4,5],[]],[[0,0,0,1,1,2,2,2,3],[0,0,1,2,2,2,2,3,3,3],[]],[[0,0,0,0,1,1,1,2,2],[0,0,0,0,0,1,1,1,2,2],[]],[[],[],[]],[[],[],[]]),
    ...
    "Nitroglycergnat":new raid("Medium","Guild raid","EHL",["Nature",16,45,240],["75,000","225,000","675,000"],["500","2,000","5,000","15,000","30,000","50,000","75,000","100,000","125,000","150,000"],["???","225,000","???"],["???","675,000","???"],"",false,false,[[1,2,3,4,6,8,11,13,14,15],[],[]],[[1,2,3,4,6,8,11,13,14,15],[],[]],[[0,0,0,0,0,1,2,2,2,3],[],[]],[[],[],[]],[[],[],[]]),
    "Rogue Slime":new raid("Small","Guild raid","EHL",["Acid",15,40,160],["150,000","450,000","1,350,000"],["5,000","15,000","50,000","80,000","120,000","150,000","180,000","210,000","250,000","300,000"],["???","450,000","???"],["???","1,350,000","???"],"",false,false,[[1,2,7,10,15,18,21,24,26,28],[],[]],[[1,2,7,10,15,18,21,24,26,28],[],[]],[[0,0,0,1,1,2,2,2,3,4],[],[]],[[],[],[]],[[],[],[]]),
    ...
    "Skliros":new raid("World","World raid","image",["Dark",8],[],[],[],["https://cdn.discordapp.com/attachments/830113306399604826/922193128134426704/Skliros.png"],"https://cdn.discordapp.com/attachments/830113306399604826/922193128134426704/Skliros.png"),
...
function pressButton(){
    if(button_pressed==true){ options_div.style.display="none"; main_div.style.display="none"; button_pressed=false; }
        ...
        button_pressed=true;
        main_div.style.left=document.getElementById("DotVRLT main button").getBoundingClientRect().x+"px";
        options_div.style.left=document.getElementById("DotVRLT main button").getBoundingClientRect().x-options_div.style.width.substring(0,options_div.style.width.length-2)-10+"px";
    }
}
...
function createAboutTab(){
    ...
    holes here, too.
    <br>Credits for the drop distribution (common, rare, mythic...) goes to Black Flame.</p>
    <br>
    ...
    <br>
    <p>Update logs can be found <a href='https://greasyfork.org/en/scripts/450685-dragons-of-the-void-raid-loot-tiers/versions'>here</a>.
    <br><i>Note: Your script settings may be reset after a script update.</i></p>`;
    var nv=(GM_info.scriptHandler+GM_info.version).toLowerCase().substring(0,13);
    if(nv=="greasemonkey4"){
        d.innerHTML=d.innerHTML+`
        <br>
        <p><b><u>Warning:</u> It seems that you are using Greasemonkey 4. Please, be aware that when the game launches on other websites, this script will most likely
        not work on these websites if you are using Greasemonkey 4 (by design of this extension). You will have to switch over to Tampermonkey, Violentmonkey, an earlier version of
        Greasemonkey or another user script manager. If you are only playing on the main site, then ignore this warning.</b></p>
        `;
    }
...
function in_raid_button(){
    ...
    b.style.borderRadius=border_radius;
    b.style.backgroundColor=custom_colours.Buttons;
...
function create_in_raid_div(raid_name,raid_difficulty){
    ...
    d.style.border="1px solid black";
    d.style.borderRadius=border_radius;
    d.style.overflow="auto";
    d.style.position="absolute";
    d.style.zIndex="0";
...
function create_detailed_div(raid_name,raid_difficulty){
    ...
    if(raid_list[raid_name].loot_format=="EHL"){
        ...
        i.width="400"; i.height="550"; i.style.cursor="zoom-in";
        i.src=raid_list[raid_name]["Loot table"];
        i.addEventListener("click",function(){ if(i.width>"400"||i.height>"550"){i.width="400"; i.height="550"; i.style.cursor="zoom-in";} else{i.setAttribute("width",""); i.setAttribute("height",""); i.style.cursor="zoom-out";} });
        d.appendChild(i);
    }
    //
    set_detailed_div_state();
                            ...
                            if(typeof(document.getElementsByClassName("dotv-btn dotv-btn-xl active")[0])==='object'){
                                if(document.getElementsByClassName("dotv-btn dotv-btn-xl active").length>1){
                                    ...
                                    if(raid_name in raid_list){
                                        if(raid_name=="Basiliscus" && document.getElementsByClassName("raid-header-center")[0].innerHTML.search("https://files.dragonsofthevoid.com/ui/bars/health-line.jpg")==-1){
                                            raid_name=raid_name+" (temporary beta world raid)"; // Until the Basiliscus world raid ceases to exist.
                                        }
                                        in_raid_button();
...
function actualize_corners(rounded_corners){
    if(rounded_corners==true){ border_radius="30px"; }
    else{ border_radius=""; }
    document.getElementById("DotVRLT main button").style.borderRadius=border_radius;
    document.getElementById("DotVRLT main div").style.borderRadius=border_radius;
    document.getElementById("DotVRLT options div").style.borderRadius=border_radius;
    if( document.getElementsByClassName("raid-container").length>0 ){
        document.getElementById("DotVRLT in-raid button").style.borderRadius=border_radius;
        document.getElementById("DotVRLT in-raid div").style.borderRadius=border_radius;
        document.getElementById("DotVRLT detailed div").style.borderRadius=border_radius;
    }
}
